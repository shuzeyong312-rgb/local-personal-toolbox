...
基于 Python、PySide6 和 Pillow 的本地桌面工具箱，所有图片均在本机处理，不需要登录、数据库或网络服务。

## 功能

- 图片格式转换：批量转换 JPG、PNG、WebP、BMP，支持透明背景、质量、命名冲突和输出目录设置
- 出单日历：按多阶段规则展示每日出单任务，记录完成情况和待评价订单
- 1688竞品监控 V1.1：管理竞品与分组，通过专用 Chrome 手动采集并保存 SQLite 历史快照
...
- [项目架构与功能全景说明](docs/项目架构与功能全景说明.md)：面向 ChatGPT、Codex 和开发者的架构、功能、数据流、配置、测试与扩展说明。
- [图片格式转换功能 PRD v1.0](docs/图片格式转换功能-PRD-v1.0.md)
- [出单日历功能 PRD v1.0](docs/出单日历功能-PRD-v1.0.md)
- [1688竞品监控工具 V1 PRD](docs/1688竞品监控工具_V1_PRD.md)
