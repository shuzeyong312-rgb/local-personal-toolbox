...
TOOL_REGISTRY = (
    ...
    ToolDefinition("background_remove", "白底转透明", "批量移除浅色商品背景，生成透明 PNG。", "图片工具", "cutout", BackgroundRemovePage, False, False, "small"),
    ToolDefinition("compression", "批量图片压缩", "减小文件体积，尽量保持图片清晰。", "图片工具", "compress", CompressionPage, False, True, "medium"),
    ...
    ToolDefinition("competitor_monitor", "1688竞品监控", "跟踪竞品价格、销量和异常变化。", "电商运营", "monitor", CompetitorMonitorPage, False, True, "medium"),
)
